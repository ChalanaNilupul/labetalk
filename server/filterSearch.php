...
if ($min == 0 && $max == 0 && $category != "anyCategory" && $location != "anyCity") {
    $sql = "SELECT * FROM `ads` WHERE `status`='active' 
        ...
        AND `place` LIKE '%$location%' LIMIT 9";
    $sqlCount  = "SELECT * FROM `ads` WHERE `status`='active' 
        AND `category` = '$category'
        AND `place` LIKE '%$location%'";
}
...
if ($min == 0 && $max == 0 && $category == "anyCategory" && $location != "anyCity") {
    $sql = "SELECT * FROM `ads` WHERE `status`='active' AND `place` LIKE '%$location%' LIMIT 9";
    $sqlCount  = "SELECT * FROM `ads` WHERE `status`='active' AND `place` LIKE '%$location%'";
}
